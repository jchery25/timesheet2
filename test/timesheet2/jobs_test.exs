defmodule Timesheet2.JobsTest do
  ...
  describe "jobs" do
    ...
    @valid_attrs %{budget: "120.5", desc: "some desc", job_code: "some job_code", name: "some name"}
    @update_attrs %{budget: "456.7", desc: "some updated desc", job_code: "some updated job_code", name: "some updated name"}
